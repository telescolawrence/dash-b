...
if(isset($_POST['submit'])){
        ...
        $sql = "INSERT INTO middle_scores_round1 (team_name, group_name, launching_points, flight_path_points, alliance_victory_points, 
...
<div class="display">
        ...
        <button class="open two"><a href="round1mid.php">Back</a></button> 
    </div>
    <!-- The Modal -->
