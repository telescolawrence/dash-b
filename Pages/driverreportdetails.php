                    ...
                    <div class="tab-content custom-menu-content">
                        ...
                        <div id="driver" class="tab-pane active notika-tab-menu-bg animated flipInX">
                            <ul class="notika-main-menu-dropdown">
                                ...
                                <li><a href="driverreportdetails.php" style="color: red"><b><u>Accomplishment Report Details</u></b></a>
                                </li>
                    ...
                    <div class="data-table-list">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="col-lg-7 col-md-4 col-sm- col-xs-4">
                                                            <div class="form-group ic-cmp-int">
                                                                ...
                                                                <div class="nk-int-st">
                                                                    <input class="form-control" placeholder="Enter Shipping Code" type="text">
                                                                </div>
                                                            </div>
                                                        </div>
                                                   <div class="col-lg-5 col-md-4 col-sm- col-xs-4">
                                                            <div class="form-group ic-cmp-int">
                                                                ...
                                                                <div class="nk-int-st">
                                                                    <input class="form-control" placeholder="Driver's Fee" type="number">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="row">
                                                <div class="col-lg-7 col-md-4 col-sm- col-xs-4" style="">
                                                            <div class="form-group ic-cmp-int">
                                                                <div class="form-ic-cmp">
                                                                    <i class="fa fa-edit"></i>
                                                                </div>
                                                   ...
                                                   <div class="col-lg-5 col-md-4 col-sm- col-xs-4">
                                                            <div class="form-group ic-cmp-int">
                                                                ...
                                                                <div class="nk-int-st"><p style="margin-top: -9%; font-size: 10px">Date Delivered.</p>
                        ...
                        <div class="table-responsive">
                            <table id="data-table-basic" class="table table-striped">
                                ...
                                <tbody>
                                    <tr>
                                        <td><small>S1-67782</small></td>
                                        <td><b style="color: blue"><i>$200</i></b></td>
                                        <td>Jhone Vicent Hilamosa</td>
